...
<!--Article -->				
	...
	<!-- From: https://en.wikipedia.org/wiki/Video_game -->
						...
						<h3 class="c-heading c-heading--large">Story and setting</h3>
							 ...
							 <p>The story often provides much of the entertainment in the game. Because these games have strong storylines, they can often make effective use of recorded dialog and voiceover narration. Players of these games tend to appreciate long cutscenes more than players of faster action games. While most games advance the plot when the player defeats an enemy or completes a level, role-playing games often progress the plot based on other important decisions. For example, a player may make the decision to join a guild, thus triggering a progression in the storyline that is usually irreversible. New elements in the story may also be triggered by mere arrival in an area, rather than completing a specific challenge. The plot is usually divided so that each game location is an opportunity to reveal a new chapter in the story.</p>	
							 
							 <p>Pen-and-paper role-playing games typically involve a player called the gamemaster (or GM for short) who can dynamically create the story, setting, and rules, and react to a player's choices. In role-playing video games, the computer performs the function of the gamemaster. This offers the player a smaller set of possible actions, since computers can't engage in imaginative acting comparable to a skilled human gamemaster. In exchange, the typical role-playing video game may have storyline branches, user interfaces, and stylized cutscenes and gameplay to offer a more direct storytelling mechanism. </p>
