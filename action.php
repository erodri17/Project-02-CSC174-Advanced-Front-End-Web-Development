...
<!--<<<<<< HEAD-->
			   ...
			   <!-- </article>-->
						...
						<div class="o-grid o-grid--wrap o-grid--demo">
                <div class="o-grid__cell o-grid__cell--width70 o-grid__cell--width-70@small">
...
<div class="o-grid o-grid--wrap o-grid--demo">
	...
	<p>Black Ops III takes place in 2065, 40 years after the events of Black Ops II, in a world facing upheaval from climate change and new technologies. Similar to its predecessors, the story follows a group of black ops soldier. The game's campaign is designed to support 4-player cooperative gameplay, allowing for bigger, more open level design and less corridor shooting. As the player character is cybernetically enhanced, players have access to various special activities. The game also features a standalone Zombie mode, and a "Nightmare" mode which will be unlocked after the player completes all campaign missions.</p>
...
<div class="o-grid o-grid--wrap o-grid--demo">
	<div class="o-grid__cell o-grid__cell--width-70@small">
<h4 class="c-heading c-heading--xlarge">Campaign</h4>
...
<h4 class="c-heading c-heading--xlarge">Multiplayer</h4>

<p>The multiplayer introduces a new momentum-based movement system, which utilizes thruster packs to allow players to perform slow boosts into the air, as well as perform wall running and sliding, all the while giving players complete gun control. In addition to the Pick 10 class system from Black Ops II, Treyarch implemented a character system called "Specialists", where players can pick from 9 different soldiers, each with either a special weapon or ability unique to them. A new "Gunsmith" feature offers aesthetic variations in weapon attachments, allowing various weapon customization combinations. The Paintshop feature allows players to create their own custom prints onto specific portions of a gun, further emphasizing the depth of customization in the game.</p>

<h4 class="c-heading c-heading--xlarge">Zombies</h4>
...
<!--Topical footer -->
                ...
                <footer>
						...
						<ul class="c-list">
							...
							<li  class="c-list__item">"Action Game". Wikipedia. 16 September 2016. Web. 26 September 2016. <a  class="c-link" href="https://en.wikipedia.org/wiki/Action_game">https://en.wikipedia.org/wiki/Action_game</a>.</li>
							<li class="c-list__item">"Call of Duty (video game)". Wikipedia. 6 September 2016. Web. 26 September 2016. <a  class="c-link" href="https://en.wikipedia.org/wiki/Call_of_Duty_(video_game)">https://en.wikipedia.org/wiki/Call_of_Duty_(video_game)</a>.</li>

							<li class="c-list__item">"Black Ops III". Wikipedia. 1 October 2016. Web. 2 October 2016. <a class="c-link" href="https://en.wikipedia.org/wiki/Call_of_Duty:_Black_Ops_III">https://en.wikipedia.org/wiki/Call_of_Duty:_Black_Ops_III</a>
