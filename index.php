...
<body class="parallax">
	...
	<!--This is one of the original scripts in the source code, it has commented out for future referece-->
	<!--Beginning of Script--->
						...
						<div class="o-container o-container--large">
							<div class= "o-grid">
								...
								<div class= "o-grid">
									...
									<!--Placeholder - Maybe a javascript embedded video to go here? -->
									<div class="o-grid__cell o-grid__cell--width-30">
